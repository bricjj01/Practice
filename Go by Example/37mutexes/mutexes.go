...
/*
Running the program shows that we executed about 90,000 total
operations against our mutex-synchronized state.

Next we’ll look at implementing this same state management task
using only goroutines and channels.
*/
